...
export const metadata = {
  title: "Precios sesiondefotos con IA | sesiondefotos.ai",

  description:
    "Ahorre en fotógrafos costosos y cree una apariencia consistente. ¡Vea paquetes y ahorre tiempo y dinero!",
};
